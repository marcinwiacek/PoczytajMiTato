...
public class IBUK extends StoreInfo {
    ...
    public boolean doesItMatch(String name, String url, StringBuilder pageContent,
        ...
        while (true) {
            ...
            toPosition = pageContent.indexOf("<div style=\"clear: both; width: 100%;\"></div>",
                    fromPosition);
            ...
            singleBook.smallThumbnailUrl = "https://www.ibuk.pl" +
                    Utils.findBetween(Utils.findBetween(s,
                            "<div class=\"tablecell okladaka\">", "</div>",
                            0), "<img src=\"", "\"", 0);
            ...
            singleBook.authors[0] = Utils.findBetween(Utils.findBetween(s,
                    "<span><a href=\"https://www.ibuk.pl/szukaj/", "/a>",
                    0), "\">", "<", 0);
